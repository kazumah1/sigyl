...
// Extract Sequential Thinking tools for standalone use
function createSequentialThinkingTools(config: z.infer<typeof configSchema>) {
  return {
    createServer: () => {
...
export default function createStatelessServer({
  ...
  const { createServer } = createSequentialThinkingTools(config);
  return createServer();
}
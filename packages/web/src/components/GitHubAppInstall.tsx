      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <div>
              <h4 className="font-medium">Secure Repository Access</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <div>
              <h4 className="font-medium">One-Step Authentication</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="text-center text-sm text-gray-500">
          <p>By installing the GitHub App, you agree to grant access to your repositories for MCP server deployment.</p>
        </div>
      </CardContent>
    </Card>
  )

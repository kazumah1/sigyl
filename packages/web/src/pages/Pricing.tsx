      ...
      <div className="container mx-auto px-6 py-8 mt-16 relative z-10">
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="hero-heading text-3xl sm:text-4xl lg:text-5xl xl:text-6xl mb-4">SIGYL is Free!</h1>
            <p className="hero-subheading text-lg sm:text-xl max-w-2xl mx-auto">
              We offer what everyone else charges $100+ for at absolutely zero cost.
            </p>
          </div>
          {/* Rickroll GIF Embed */}
          ...
          <div className="flex justify-center">
            <div className="card-modern p-10 flex flex-col items-center h-full min-h-[600px] max-w-xl w-full">
              <div className="text-4xl font-bold text-white mb-2">$0</div>
              <div className="text-2xl font-bold text-white mb-6 mt-2">What you get</div>
              ...
              <div className="flex flex-col gap-4 w-full">
                <Button 
                  onClick={handleFree}
                  className="w-full bg-white text-black font-semibold py-3 rounded-lg border border-white hover:bg-gray-100 hover:text-black transition-colors mt-2"
                  style={{ fontFamily: 'Space Grotesk, Inter, system-ui, sans-serif', fontSize: '1.08rem' }}
                >
                  Get Started Free
                </Button>
                <Button 
                  className="w-full bg-black text-white font-semibold py-3 rounded-lg border border-white hover:bg-gray-900 hover:text-white transition-colors"
                  style={{ fontFamily: 'Space Grotesk, Inter, system-ui, sans-serif', fontSize: '1.08rem' }}
                  onClick={() => navigate('/contact')}
                >
                  Request More Free Features
                </Button>
              </div>
            </div>
          </div>

...
function testAdminOperations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const packages = yield (0, index_1.getAllPackagesAdmin)({ registryUrl });
        ...
        try {
            const packages = yield (0, index_1.getAllPackagesAdmin)({
                registryUrl,
        ...
        try {
            ...
            const packages = yield sdk.getAllPackages();
        ...
        try {
            ...
            const packages = yield sdk.searchAllPackages(50);

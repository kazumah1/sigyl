...
console.log("[WRAPPER-STAGE3] Starting MCP Wrapper v20.0.0");
console.log("[WRAPPER-STAGE3] Stage 3: Improved wrapper with better multi-key support");
...
(async () => {
  ...
  // Fetch secrets from database - IMPROVED for multiple keys
